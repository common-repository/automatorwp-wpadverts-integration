...
class AutomatorWP_WPAdverts_Send_Message extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User sends a message to an advert author', 'automatorwp-wpadverts-integration' ),
            'select_option'     => __( 'User <strong>sends a message</strong> to an advert author', 'automatorwp-wpadverts-integration' ),
            /* translators: %1$s: Post Title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User sends a message to %1$s author time(s)', 'automatorwp-wpadverts-integration' ), '{post}', '{times}' ),
            /* translators: %1$s: Post Title. */
            'log_label'         => sprintf( __( 'User sends a message to %1$s author', 'automatorwp-wpadverts-integration' ), '{post}' ),
            ...
            'tags' => array_merge(
                automatorwp_utilities_post_tags( __( 'Advert', 'automatorwp-wpadverts-integration' ) ),

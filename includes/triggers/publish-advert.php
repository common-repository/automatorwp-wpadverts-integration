...
class AutomatorWP_WPAdverts_Publish_Advert extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User publishes an advert', 'automatorwp-wpadverts-integration' ),
            'select_option'     => __( 'User publishes <strong>an advert</strong>', 'automatorwp-wpadverts-integration' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User publishes an advert %1$s time(s)', 'automatorwp-wpadverts-integration' ), '{times}' ),
            'log_label'         => __( 'User publishes an advert', 'automatorwp-wpadverts-integration' ),
